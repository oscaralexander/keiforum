...
<li {{ $attributes->class(['topicListItem']) }}>
    ...
    <div class="topicListItem__text">
        ...
        <ul class="meta">
            ...
            @if ($topic->latestPost)
                <li class="meta__item">
                    <a aria-label="@lang('forum/show.latest_post_label', ['topic' => $topic->title])" href="{{ route('topic.show', [$topic->forum, $topic, $topic->slug, 'post' => $topic->latestPost->id]) }}" wire:navigate>
